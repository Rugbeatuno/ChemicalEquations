...
var countSigFigs = function (num) {
    var sigFigs = 0;
    var numString = num.toString();
    var containsDot = numString.indexOf(".") > -1;
    // remove trailing zeros
    var numString2 = num.toString();
    while (true) {
    ...
    for (var i = 0; i < numString2.length; i++) {
        var digitAsString = numString2.charAt(i);
    ...
    for (var i = 0; i < numString2.length; i++) {
        var digitAsString = numString2.charAt(i);
        if (digitAsString === "0") {
            for (var _i = 0, digitLocs_1 = digitLocs; _i < digitLocs_1.length; _i++) {
                var idx = digitLocs_1[_i];
                if (idx > i) {
                    sigFigs++;
                    break;
                }
...
exports.countSigFigs = countSigFigs;
